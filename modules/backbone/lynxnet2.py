...
class LYNXNet2(nn.Module):
    def __init__(
            ...
            *,
            num_layers=6, num_channels=512, expansion_factor=1, kernel_size=31,
            dropout=0.0
    ):
        """
        ...
        """
        super().__init__()
        self.in_dims = sample_dim
        self.input_projection = nn.Linear(sample_dim, num_channels)
        self.conditioner_projection = nn.Linear(condition_dim, num_channels)
        ...
        self.output_projection = nn.Linear(num_channels, sample_dim)
